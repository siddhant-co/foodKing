...
//             id: item.id, // ✅ use backend ID directly
...
//   const handleRemove = async (item: { id: number; productId: number; variantId: number | null | undefined }) => {
//     try {
//       await deleteCartItem(item.id, token ?? '');
  
//       dispatch(removeFromCartState({
//         productId: item.productId,
//         variantId: item.variantId ?? null  // <-- normalize it
//       }));
...
//             className="w-8 h-8 flex items-center justify-center hover:bg-gray-200 rounded-full transition disabled:opacity-40 disabled:cursor-not-allowed"
//           >
...
//           className="text-red-500 hover:text-red-600 transition absolute top-2 right-2 p-1 cursor-pointer"
...
//         className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg shadow-sm disabled:opacity-50 transition"
//       >
//         ← Previous
//       </button>
...
//             className="w-full py-3 px-6 rounded text-lg font-semibold text-white bg-green-600 hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-md"
//           >
//             🛒 Proceed To Checkout
//           </button>
...
//             className="w-full mt-4 py-3 px-6 rounded text-lg font-semibold text-white bg-red-500 hover:bg-red-600 transition-all duration-300 transform hover:scale-105 shadow-md"
//           >
//             🗑️ Clear Cart
//           </button>
...
//             <button
//               type="button"
//               className="w-full mt-4 py-3 px-6 rounded text-lg font-semibold text-white bg-blue-500 hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 shadow-md"
//             >
//               🛍️ Continue Shopping
//             </button>
//           </Link>
